function [ ELx, ELy, ELz ] = EL_terms(matrix, K11, K22, K33, deltax, deltay, deltaz, wbcMatrix)
...
Elsx = ((-1).*d2Nxdxdy+(-1).*d2Nydydy+(-1).*d2Nzdydz).*K11+K33.*(Nx.*(( ...
  -1).*dNydz.*dNzdx+(-1).*(dNxdz+(-2).*dNzdx).*dNzdy+(dNxdy+(-1).* ...
  dNydx).*(2.*dNxdx+dNzdz)+(d2Nxdxdy+(-1).*d2Nydxdx).*Nx)+(d2Nxdxdy+ ...
  (-1).*d2Nydxdx+(-1).*d2Nydzdz+d2Nzdydz).*Ny.^2+(dNxdz.*(2.*dNxdy+( ...
  -1).*dNydx)+(-1).*dNxdy.*dNzdx+(-1).*(dNydz+(-1).*dNzdy).*(dNxdx+ ...
  2.*dNzdz)+(d2Nxdydz+(-2).*d2Nydxdz+d2Nzdxdy).*Nx).*Nz+((-1).* ...
  d2Nydzdz+d2Nzdydz).*Nz.^2+(-1).*Ny.*((-1).*dNxdy.^2+dNydx.^2+ ...
  dNydz.^2+(dNxdz+(-1).*dNzdx).^2+(-1).*dNzdy.^2+(d2Nxdzdz+(-1).* ...
  d2Nzdxdz).*Nx+((-1).*d2Nxdxdz+d2Nzdxdx).*Nz))+K22.*(((-1).* ...
  d2Nydzdz+d2Nzdydz).*Nx.^2+Nz.*(dNxdz.*((-2).*dNxdy+dNydx)+(3.* ...
  dNxdy+(-2).*dNydx).*dNzdx+dNxdx.*(dNydz+(-1).*dNzdy)+(d2Nxdxdy+( ...
  -1).*d2Nydxdx).*Nz)+Ny.*(2.*(dNxdz+(-1).*dNzdx).^2+(d2Nxdzdz+(-1) ...
  .*d2Nzdxdz).*Nx+((-1).*d2Nxdxdz+d2Nzdxdx).*Nz)+(-1).*Nx.*(dNxdz.*( ...
  2.*dNydz+(-3).*dNzdy)+(-1).*dNzdx.*(dNydz+(-2).*dNzdy)+(dNxdy+(-1) ...
  .*dNydx).*dNzdz+(d2Nxdydz+(-2).*d2Nydxdz+d2Nzdxdy).*Nz));


Elsy = ((-1).*d2Nxdxdy+(-1).*d2Nydydy+(-1).*d2Nzdydz).*K11+K33.*(Nx.*(( ...
  -1).*dNydz.*dNzdx+(-1).*(dNxdz+(-2).*dNzdx).*dNzdy+(dNxdy+(-1).* ...
  dNydx).*(2.*dNxdx+dNzdz)+(d2Nxdxdy+(-1).*d2Nydxdx).*Nx)+(d2Nxdxdy+ ...
  (-1).*d2Nydxdx+(-1).*d2Nydzdz+d2Nzdydz).*Ny.^2+(dNxdz.*(2.*dNxdy+( ...
  -1).*dNydx)+(-1).*dNxdy.*dNzdx+(-1).*(dNydz+(-1).*dNzdy).*(dNxdx+ ...
...
Elsz = ((-1).*d2Nxdxdz+(-1).*d2Nydydz+(-1).*d2Nzdzdz).*K11+K33.*(Nx.*(( ...
  -1).*dNxdy.*dNydz+(2.*dNxdx+dNydy).*(dNxdz+(-1).*dNzdx)+dNydx.*( ...
  2.*dNydz+(-1).*dNzdy)+(d2Nxdxdz+(-1).*d2Nzdxdx).*Nx)+(dNxdz.*(2.* ...
  dNxdy+(-1).*dNydx)+(-1).*dNxdy.*dNzdx+(dNxdx+2.*dNydy).*(dNydz+( ...
  -1).*dNzdy)+(d2Nxdydz+d2Nydxdz+(-2).*d2Nzdxdy).*Nx).*Ny+(d2Nydydz+ ...
  (-1).*d2Nzdydy).*Ny.^2+(dNxdz.^2+(-1).*(dNxdy+(-1).*dNydx).^2+ ...
  dNydz.^2+(-1).*dNzdx.^2+(-1).*dNzdy.^2+((-1).*d2Nxdydy+d2Nydxdy).* ...
  Nx+(d2Nxdxdy+(-1).*d2Nydxdx).*Ny).*Nz+(d2Nxdxdz+d2Nydydz+(-1).* ...
  d2Nzdxdx+(-1).*d2Nzdydy).*Nz.^2)+K22.*((d2Nydydz+(-1).*d2Nzdydy).* ...
  Nx.^2+(d2Nxdxdz+(-1).*d2Nzdxdx).*Ny.^2+2.*(dNxdy+(-1).*dNydx).^2.* ...
  Nz+(-1).*Ny.*(dNxdz.*(2.*dNxdy+(-3).*dNydx)+(-1).*(dNxdy+(-2).* ...
  dNydx).*dNzdx+dNxdx.*(dNydz+(-1).*dNzdy)+(d2Nxdydz+d2Nydxdz+(-2).* ...
  d2Nzdxdy).*Nx+(d2Nxdxdy+(-1).*d2Nydxdx).*Nz)+Nx.*(dNydy.*((-1).* ...
  dNxdz+dNzdx)+dNxdy.*(3.*dNydz+(-2).*dNzdy)+dNydx.*((-2).*dNydz+ ...
  dNzdy)+(d2Nxdydy+(-1).*d2Nydxdy).*Nz));
...
Elwx = ((-1).*d2Nxdxdx+(-1).*d2Nydxdy+(-1).*d2Nzdxdz).*K11+K22.*(((-1).* ...
  d2Nxdzdz+d2Nzdxdz).*Ny.^2+Nz.*(dNydy.*(dNxdz+(-1).*dNzdx)+dNxdy.*( ...
  dNydz+(-2).*dNzdy)+dNydx.*((-2).*dNydz+3.*dNzdy)+((-1).*d2Nxdydy+ ...
  d2Nydxdy).*Nz)+(-1).*Ny.*(dNxdz.*(2.*dNydz+(-1).*dNzdy)+dNzdx.*(( ...
  -3).*dNydz+2.*dNzdy)+((-1).*dNxdy+dNydx).*dNzdz+((-1).*d2Nydzdz+ ...
  d2Nzdydz).*Nx+((-2).*d2Nxdydz+d2Nydxdz+d2Nzdxdy).*Nz)+Nx.*(2.*( ...
  dNydz+(-1).*dNzdy).^2+((-1).*d2Nydydz+d2Nzdydy).*Nz))+K33.*(((-1) ...
  .*d2Nxdydy+(-1).*d2Nxdzdz+d2Nydxdy+d2Nzdxdz).*Nx.^2+(-1).*Ny.*( ...
  dNydz.*dNzdx+(dNxdz+(-2).*dNzdx).*dNzdy+(dNxdy+(-1).*dNydx).*(2.* ...
  dNydy+dNzdz)+(d2Nxdydy+(-1).*d2Nydxdy).*Ny)+((-1).*dNxdy.*dNydz+ ...
  dNydx.*(2.*dNydz+(-1).*dNzdy)+(-1).*(dNxdz+(-1).*dNzdx).*(dNydy+ ...
  2.*dNzdz)+((-2).*d2Nxdydz+d2Nydxdz+d2Nzdxdy).*Ny).*Nz+((-1).* ...
  d2Nxdzdz+d2Nzdxdz).*Nz.^2+(-1).*Nx.*(dNxdy.^2+dNxdz.^2+(-1).* ...
  dNydx.^2+(-1).*dNzdx.^2+(dNydz+(-1).*dNzdy).^2+(d2Nydzdz+(-1).* ...
  d2Nzdydz).*Ny+((-1).*d2Nydydz+d2Nzdydy).*Nz))+(-2).*Ws.*Wx.*(Nx.* ...
  Wx+Ny.*Wy+Nz.*Wz);


Elwy = ((-1).*d2Nxdxdx+(-1).*d2Nydxdy+(-1).*d2Nzdxdz).*K11+K22.*(((-1).* ...
  d2Nxdzdz+d2Nzdxdz).*Ny.^2+Nz.*(dNydy.*(dNxdz+(-1).*dNzdx)+dNxdy.*( ...
  dNydz+(-2).*dNzdy)+dNydx.*((-2).*dNydz+3.*dNzdy)+((-1).*d2Nxdydy+ ...
  d2Nydxdy).*Nz)+(-1).*Ny.*(dNxdz.*(2.*dNydz+(-1).*dNzdy)+dNzdx.*(( ...
  -3).*dNydz+2.*dNzdy)+((-1).*dNxdy+dNydx).*dNzdz+((-1).*d2Nydzdz+ ...
...
Elwz = ((-1).*d2Nxdxdz+(-1).*d2Nydydz+(-1).*d2Nzdzdz).*K11+K33.*(Nx.*(( ...
  -1).*dNxdy.*dNydz+(2.*dNxdx+dNydy).*(dNxdz+(-1).*dNzdx)+dNydx.*( ...
  2.*dNydz+(-1).*dNzdy)+(d2Nxdxdz+(-1).*d2Nzdxdx).*Nx)+(dNxdz.*(2.* ...
  dNxdy+(-1).*dNydx)+(-1).*dNxdy.*dNzdx+(dNxdx+2.*dNydy).*(dNydz+( ...
  -1).*dNzdy)+(d2Nxdydz+d2Nydxdz+(-2).*d2Nzdxdy).*Nx).*Ny+(d2Nydydz+ ...
  ...
  d2Nzdxdy).*Nx+(d2Nxdxdy+(-1).*d2Nydxdx).*Nz)+Nx.*(dNydy.*((-1).* ...
  dNxdz+dNzdx)+dNxdy.*(3.*dNydz+(-2).*dNzdy)+dNydx.*((-2).*dNydz+ ...
  dNzdy)+(d2Nxdydy+(-1).*d2Nydxdy).*Nz))+(-2).*Ws.*Wz.*(Nx.*Wx+Ny.* ...
  Wy+Nz.*Wz);

screen = (~(Ws==0));
ELx(screen) = Elsx(screen);
ELy(screen) = Elsy(screen);
ELz(screen) = Elsz(screen);

ELx(~screen) = Elwx(~screen);
ELy(~screen) = Elwy(~screen);
ELz(~screen) = Elwz(~screen);
